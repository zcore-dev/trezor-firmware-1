...
_cached_keychain = None  # type: Optional[Keychain]
...
def get_keychain() -> Optional[bytes]:
    return _cached_keychain
...
def set_keychain(seed: Optional[Keychain]) -> None:
    global _cached_keychain
    _cached_keychain = seed
