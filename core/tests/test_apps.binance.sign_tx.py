...
class TestBinanceSign(unittest.TestCase):
    def testTransactionSignature(self):
        ...
        msg = BinanceOrderMsg(id="B6561DCC104130059A7C08F48C64610C1F6F9064-10",
                              ordertype=2,
                              price=100000000,
                              quantity=1200000000,
                              sender="bnc1ketpmnqsgycqtxnupr6gcerpps0klyryhz6fzl",
                              side=1,
                              symbol="BTC-5C4_BNB",
                              timeinforce=1)
        ...
        self.assertTrue(verify_content_signature(pubkey, signature, unhexlify(signed_json_hex_msg)))
